...
public class CustomerServiceImpl implements CustomerService{
	...
	public void saveCustomer(Customer customer) {
		customerReposiyory.save(customer);
	}



	@Override
	public void activationCustomer(String telephone) {
		Customer customer=customerReposiyory.findByTelephone(telephone);
		customer.setType(1);
	...
	@Override
	public Customer queryCustomerByTelephone(String telephone) {
		return customerReposiyory.findByTelephone(telephone);
	}
	...
	public Customer login(String telephone, String password) {
		return customerReposiyory.findByTelephoneAndPassword(telephone,password);
	}



	@Override
	public String queryCustomerFixedAreaId(String address) {
		Customer customer=customerReposiyory.findByAddress(address);
		if(customer!=null){
