...
public interface CustomerService {
	...
	@PUT
	@Path("/activationCustomer")
	public void activationCustomer(@QueryParam("telephone")String telephone);
	
	
	@GET    
	@Path("/queryCustomerByTelephone")
	public 	Customer queryCustomerByTelephone(@QueryParam("telephone")String telephone);
	...
	@GET
	@Path("/queryCustomerFixedAreaId")
	public String queryCustomerFixedAreaId(@QueryParam("address")String address);
